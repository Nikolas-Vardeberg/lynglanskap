...
export default function Home() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 bg-[#CDD8E4]">
      <div className="flex flex-col justify-between h-screen w-full text-center py-12 md:py-20 2xl:py-20 2xl:px-40  px-10  container">
        <div>
          ...
          <div className="flex mt-28 flex-col space-y-[26px]">
            <h1 className="text-[#333333]  text-3xl sm:text-4xl md:text-left md:text-4xl lg:text-5xl">Din Landskapsarkitekt Konsulent</h1>
            <h2 className="text-gray-400 md:text-left text-lg sm:text-2xl md:text-lg lg:text-[24px]">Vi er to landskapsarkitekter som tilbyr konsulenttjenester innen landskapsarkitektur. Vi skaper vakre og funksjonelle utendørsområder for både private og offentlige prosjekter.</h2>
